...
type TMobileActiveNavProps = {
  toggleMenuOpen: () => void;
};
const MobileActiveNav = ({
  toggleMenuOpen,
}: TMobileActiveNavProps) => {
  return (
    <div className="bg-overlay opacity-80 min-h-screen px-7  w-full absolute top-0 left-0">
      ...
      <div className="flex flex-col">
        <Separator />
        <NavLinks separatorIsVisible={true} className="text-4xl text-white font-bold text-center" />
        <Button
          label="Login"
          className="text-white uppercase text-2xl font-semibold border-2 h-12"
        />
        <div className="flex  gap-9 justify-center pb-12 pt-48">
          <Button
            svgFile={
...
export default MobileActiveNav;
