...
import MobileActiveNav from "./MobileActiveNav";
...
const Headers = () => {
  ...
  return (
    <header className="relative xl:px-40">
      {/* Mobile Device */}
      {isMenuOpen && <MobileActiveNav toggleMenuOpen={toggleMenuOpen} />}

      <div className="flex justify-between items-center px-7 py-8">
        <Link className="cursor-pointer" href={"/"}>
          <svg width="148" height="25">
        ...
        <div className="hidden md:flex gap-8 items-center">
            ...
            />
          <Button label="Login" className="text-white px-6 bg-softRed hover:border-softRed hover:text-softRed hover:bg-white transition-colors ease-in-out duration-200  uppercase rounded-lg   font-semibold border-2 h-12"/>
        </div>
      </div>
    </header>
  );
