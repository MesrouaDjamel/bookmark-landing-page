...
const Footer = () => {
  return (
    <footer className="pb-11 bg-veryDarkBlue flex flex-col md:px-16 xl:px-40 2xl:px-96 md:flex-row  sm:justify-between  items-center ">
      <div className="pt-8 flex flex-col gap-9 sm:flex-row">
        ...
        <NavLinks
          ulClassName="flex flex-col gap-8 sm:flex-row "
          className="text-white text-center  font-semibold "
          separatorIsVisible={false}
        />
      </div>

      <div className="flex gap-9 justify-center  pt-9">
        <Button
          svgFile={
            <svg
              className="fill-white hover:fill-softRed transition-colors ease-in-out duration-300  "
              width="24"
              height="24"
            >
              <path
